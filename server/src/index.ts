...
const init = async () => {
  ...
  const tasks = await Task.bulkCreate([
    { title: '牛乳を買う', description: 'スーパーで牛乳と卵を買う', due_date: '2026-01-22', location: '近所のスーパー', status: 'pending' },
    { title: 'レポート提出', description: '月曜日の朝までに提出', due_date: '2026-01-23', location: '大学', status: 'completed' },
    { title: 'ランニング', description: '公園を5km走る', due_date: '2026-01-20', location: '中央公園', status: 'pending' },
  ]);
